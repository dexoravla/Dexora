import argparse
import os
from train.train_scoring import train_scoring_model

from accelerate.logging import get_logger


def parse_args(input_args=None):
    parser = argparse.ArgumentParser(description="Main script for training scoring model.")
    parser.add_argument(
        "--config_path",
        type=str,
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="checkpoints/scoring_model",
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path or name of a pretrained scoring model to load.",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.1,
        help="The probability to randomly mask the conditions during training.",
    )
    parser.add_argument(
        "--cam_ext_mask_prob",
        type=float,
